...
const Row2 = styled.div`
  ...
  grid-template-areas: "flex contact" "connect contact";
  column-gap: 10em;
  row-gap: 3em;
...
const PageLinksContainer = styled.div<{ "grid-area": string }>`
  ...
  return (
    <Container>
      <MainArea>
        ...
        <Row2>
          <PageLinksContainer grid-area="flex">
          ...
          <Row3>
            ...
            <div className="connect-us-items">
              ...
              <p className="details">
                <Link href="tel:+91 8923456789">+91 9115997999</Link>
              </p>
            </div>
            <div className="connect-us-items">
              <span className="icons">
